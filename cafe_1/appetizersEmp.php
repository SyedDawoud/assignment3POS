				...
				<div class="container">
					<nav class="navbar navbar-default">
						...
						<div class="navbar-header w3l_logo">
							...
							<h1><a href="index_Employee.html">Staple<span>Best Food Collection</span></a></h1>
						</div> 
						<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
							<ul class="nav navbar-nav navbar-right">
								...
								<!-- Mega Menu -->
								<li class="dropdown">
									<a href="menuEmp.html" >Menu <b class="caret"></b></a>
...
$sql="select * from meal where Type='Appetizer'";
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front"> 
									<img src="../cafe_central/php/$row[Image]" class="img-responsive" alt="img">
