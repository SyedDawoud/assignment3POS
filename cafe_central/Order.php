...
echo<<<_END
			<div>
				<span class="text-primary"> $row[Name]  &nbsp &nbsp | </span>
				<span class="text-primary" name="$row[Name]price"> Price : $row[Cost]  &nbsp &nbsp |</span>
				<span class="text-primary"> Quantity </span> <input type="number" min=0  max=$row[Available_count] name="item2[]"  />
				<input type="checkbox" name="item[]" value="$row[Name]">
			</div>
